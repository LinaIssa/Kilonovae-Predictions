...
double sample_emissivity(double Temp, double *tcurrent, double *tgrid, int *nx, double *dgrid, double *dens, double *Ye, double *Ye_crit, double *x, double *ksc_free, double *ksc_rich, double *kabs_par_free, double *kabs_par_rich, double *emiss, double *nu_cmf);
