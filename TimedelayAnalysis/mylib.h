...
double tau_boundary(double *x, int *photosph_flag, double *ax_source, int *ngrid_tot, double *dgrid, double *ksc_dyn_lanth_free, double *ksc_dyn_lanth_rich,  double *kabs_par_free, double *kabs_par_rich, int *tdep, double *temission, double *tcurrent, double *tgrid, double *dens, double *Ye, double *Ye_crit, double *n, double *nmax_eps, double *tau_max, double *dbound, double *nu_rf) ;

double tau_cont(double *x, double *ksc_free, double *ksc_rich, double *kabs_par_free, double *kabs_par_rich, int *tdep, double *tcurrent, double *tgrid, int *ngrid_tot, double *dgrid, double *dens, double *Ye, double *Ye_crit, double *n, double *s_l, double *nu_rf) ;

double s_cont(double *x, double *ksc_free, double *ksc_rich, double *kabs_par_free, double *kabs_par_rich, int *tdep, double *tcurrent, double *tgrid, double *n, int *ngrid_tot, double *dgrid, double *dens, double *Ye, double *Ye_crit, double *tau_ev, double *nmax_eps, double *tau_lines, double *nu_rf);
...
double sample_emissivity(double *T0, double *alphaT, double *tcurrent, double *tgrid, int *nx, double *dgrid, double *dens, double *Ye, double *Ye_crit, double *x, double *ksc_free, double *ksc_rich, double *kabs_par_free, double *kabs_par_rich, double *emiss, double *nu_cmf);
